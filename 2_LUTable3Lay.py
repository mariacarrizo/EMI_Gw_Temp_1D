...
np.save('Lookup_Tables/3Lay/survey_3Lay.npy', survey)
...
np.save('Lookup_Tables/3Lay/LUTable_3Lay', LUT)
np.save('Lookup_Tables/3Lay/conds', conds)
np.save('Lookup_Tables/3Lay/thicks', thicks)
