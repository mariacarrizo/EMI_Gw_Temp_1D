...
np.save('Lookup_Tables/2Lay/survey_2Lay.npy', survey)

# sampling of conductivities
nsl = 71 # number of samples
s0 = -2.5 # minimum conductivity in S/m
...
np.save('Lookup_Tables/2Lay/LUTable_2Lay', DataEM)
np.save('Lookup_Tables/2Lay/conds', conds)
np.save('Lookup_Tables/2Lay/thicks', h_1)
